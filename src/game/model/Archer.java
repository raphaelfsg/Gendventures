...
public class Archer extends Character implements Ifight, IdamageSystem, Iequips {

    private int weaponDamage;
    private int armorDefense;

    public Archer(int strength, int speed, int intelligence, int life, int weaponDamage, int armorDefense) {
    ...
    public void defenseMsg() {
        System.out.println("Arco pra guerra??? pff " + defense());
    }
